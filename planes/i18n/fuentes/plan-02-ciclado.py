...
T = {
    ...
    'LLEVA EL PROTOCOLO AL <span class="a">SIGUIENTE NIVEL</span>': {
        "en": 'TAKE THE PROTOCOL TO THE <span class="a">NEXT LEVEL</span>',
        "fr": 'PASSEZ LE PROTOCOLE AU <span class="a">NIVEAU SUIVANT</span>'},
    "Con <strong>ELITE</strong> añades el plan de entrenamiento de 8 semanas, las rutinas HIIT y la sesión de coaching donde ajustamos este ciclado a tus resultados reales.": {
        "en": "With <strong>ELITE</strong> you add the 8-week training plan, the HIIT workouts and the coaching session where we tune this cycling to your real results.",
        "fr": "Avec <strong>ÉLITE</strong>, vous ajoutez le programme d'entraînement de 8 semaines, les séances HIIT et le coaching où nous ajustons ce cyclage à vos résultats réels."},
