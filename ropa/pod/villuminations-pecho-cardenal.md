# villuminations-pecho-cardenal

| Campo | Valor |
|---|---|
| Prenda | Camiseta negra |
| Área de estampación | Frente · 12″ × 16″ · 30.5 × 40.6 cm |
| Fichero | **3602 × 4795 px** · 300 ppp · PNG con alfa |
| Dibujo dentro del lienzo | 9.0 × 9.5 cm (3.54" × 3.73") |
| Colocación | a 10.8 cm del borde izquierdo y 6.0 cm del superior |
| Tinta hueso | `#ECEFF6` |
| Tinta acento | `#BC1733` (cardenal) |
| Tinta bajo 1.0 mm | 1.0% (máximo 4%) |
| Hueco bajo 0.9 mm | 0.8% (máximo 3%) |
| Cobertura de tinta | 16% del recuadro del dibujo |
