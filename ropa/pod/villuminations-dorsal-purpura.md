# villuminations-dorsal-purpura

| Campo | Valor |
|---|---|
| Prenda | Camiseta negra |
| Área de estampación | Espalda · 12″ × 16″ · 30.5 × 40.6 cm |
| Fichero | **3602 × 4795 px** · 300 ppp · PNG con alfa |
| Dibujo dentro del lienzo | 28.0 × 32.2 cm (11.02" × 12.68") |
| Colocación | a 1.2 cm del borde izquierdo y 2.5 cm del superior |
| Tinta hueso | `#ECEFF6` |
| Tinta acento | `#6727D6` (purpura) |
| Tinta bajo 1.0 mm | 1.0% (máximo 4%) |
| Hueco bajo 0.9 mm | 1.2% (máximo 3%) |
